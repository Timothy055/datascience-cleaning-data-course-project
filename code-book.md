...
- activity - the activity the subject/user was doing at the time (can be WALKING, WALKING_UPSTAIRS, WALKING_DOWNSTAIRS, SITING, STANDING, LAYING)
- subject.id - the id of the subject/user
- tBodyAcc-mean()-X
- tBodyAcc-mean()-Y
- tBodyAcc-mean()-Z
- tBodyAcc-std()-X
